 ...
 */
package com.smilehippo.modules.gen.web;

import javax.servlet.http.HttpServletRequest;
import javax.servlet.http.HttpServletResponse;

import com.smilehippo.common.web.BaseController;
import com.smilehippo.modules.gen.service.GenSchemeService;
...
import com.smilehippo.modules.gen.service.GenTableService;
...
public class GenSchemeController extends BaseController {
	...
	public String form(GenScheme genScheme, Model model) {
		if (StringUtils.isBlank(genScheme.getPackageName())){
			genScheme.setPackageName("com.smilehippo.modules");
		}
