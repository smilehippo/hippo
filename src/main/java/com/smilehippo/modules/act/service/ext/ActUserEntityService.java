 ...
 */
package com.smilehippo.modules.act.service.ext;
...
import com.smilehippo.modules.sys.service.SystemService;
...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new com.smilehippo.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new com.smilehippo.modules.sys.entity.User(null, userId)))){
